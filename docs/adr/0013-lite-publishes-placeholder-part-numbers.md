...
- **Status:** Superseded by [ADR-0037](0037-the-bend-takes-the-clients-number-on-his-say-so.md)
- **Date:** 2026-08-03

Real numbers arrived in instalments, the last of them on 2026-09-17. Nothing in `parts.json` is
invented any more, so nothing here governs: PTSBLite no longer publishes a placeholder part
number.
