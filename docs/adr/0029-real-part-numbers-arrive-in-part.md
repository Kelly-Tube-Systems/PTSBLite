...
- **Status:** Accepted; both open questions answered in [ADR-0030](0030-the-terminal-and-pedestal-blower-take-their-real-numbers.md), the tube number corrected by the client in [ADR-0036](0036-the-client-corrects-the-tube-part-number.md), and the bend released on the client's instruction in [ADR-0037](0037-the-bend-takes-the-clients-number-unconfirmed.md)
- **Date:** 2026-09-13
