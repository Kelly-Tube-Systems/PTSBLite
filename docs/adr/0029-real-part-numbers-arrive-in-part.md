...
- **Status:** Accepted; both open questions answered in [ADR-0030](0030-the-terminal-and-pedestal-blower-take-their-real-numbers.md), the tube number corrected by the client in [ADR-0036](0036-the-client-corrects-the-tube-part-number.md), and the power box brought in by [ADR-0037](0037-the-control-box-is-a-parts-list-line-with-no-model.md)
- **Date:** 2026-09-13
