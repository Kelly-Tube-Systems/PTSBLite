...
| Part numbers | `partNo` in `src/data/parts.json` | **Real, all of them.** KTS numbers for the blower (plain and on a pedestal, one part), terminal, tube, split sleeve and bend. The client, not the STEP folder, is the source: the tube's and the bend's numbers are their 2026-09-17 correction of what the folder carried. The bend's, `ALP08401`, is printed on the client's instruction without confirmation of which radius it describes — see [ADR-0037](docs/adr/0037-the-bend-takes-the-clients-number-on-his-say-so.md). Also [ADR-0030](docs/adr/0030-the-terminal-and-pedestal-blower-take-their-real-numbers.md) and [ADR-0036](docs/adr/0036-the-client-corrects-the-tube-part-number.md). |
