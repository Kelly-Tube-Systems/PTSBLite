...
export const FREE_PLACEMENT_MESSAGES = {
  ...
  // It does not name the floor: since ADR-0032 the mast may be reaching for the
  // top of an obstacle instead, and a part is what blocks it either way.
  pedestalBlocked: "The pedestal cannot reach down — something is in the way.",
 ...
 * a pedestal blower, the mast beneath it down to whatever it stands on.
 *
 * The whole design is what tells the mast where that is — the ground on floor
 * 1, the slab on floor 2, the top of an obstacle it is standing on — so it is
